...
| Next action | **independent third-party rerun (→ CLAIMS #8)**; ICC(1,1)/(3,1) sensitivity; figure-level confirmation of ICC anchors — THEN consider v1.0 + Versioned Score Table spec freeze |
